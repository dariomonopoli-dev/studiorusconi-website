      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="flex flex-col gap-6 rounded-2xl border border-border bg-card p-8">
            ...
            <a href="https://www.instagram.com/studio_rusconi" target="_blank" rel="noopener noreferrer" className="flex items-start gap-4 transition-opacity hover:opacity-80">
